...
const MainAbout = () => {
  return (
    <div className="bg-gray-100"> {/* Solid blue background for the entire section */}
      <section
        id="features"
      ...
      >
        ...
        <div className="mb-14 text-center">
            <span className=" font-bold py-1 px-4 bg-indigo-300 rounded-full text-xl font-large text-indigo-600 text-center">
            WHY CHOOSE US
            </span>
            </div>
