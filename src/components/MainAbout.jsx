    ...
    <div className="bg-blue-500"> {/* Solid blue background for the entire section */}
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 gap-10 pt-8 sm:grid-cols-2 lg:grid-cols-3">
          {/* Vision Section */}
          <div className="rounded-md border border-neutral-800 bg-blue-600 p-8 text-center shadow">
            <div className="button-text mx-auto flex h-12 w-12 items-center justify-center rounded-md border">
              <FaEye className="text-white text-3xl" />
            </div>
            <h3 className="mt-6 text-gray-100">Vision</h3>
          ...
          <div className="rounded-md border border-neutral-800 bg-blue-600 p-8 text-center shadow">
            ...
            <h3 className="mt-6 text-gray-100">Mission</h3>
            <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-200">
          ...
          <div className="rounded-md border border-neutral-800 bg-blue-600 p-8 text-center shadow">
            ...
            <h3 className="mt-6 text-gray-100">Values</h3>
            <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-200">
              • Ethical
              <br />
              • Integrity
