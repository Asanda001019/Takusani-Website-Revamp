...
export const ServicesCards = () => {
  return (
    ...
    <div className="bg-gray-100 mt-0 text-center">
      <br></br>
      <br></br>
    <span className="fontFamily-Arial, sans-serif font-bold bg-gray-100 py-1 px-4 bg-gray-300 rounded-full text-xl font-large text-indigo-900 text-center">
          ...
          At every step of our process, we prioritize the user, ensuring<br></br> that our products and services are designed with their needs in mind.
             ...
             <br></br>
             <br></br>
    <div className=" bg-gray-100 p-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8">
      {/* Card 1 */}
